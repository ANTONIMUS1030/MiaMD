...
async function start() {
    ...
    dark.ev.on('messages.upsert', async ({ messages }) => {
        ...
        try {
            ...
            // DEFINIR DONO //
            const donoNumero = [`5592994604627@s.whatsapp.net`] //Numero do dono
...
break
   ...
   case 'a': //texto
    ...
    break
case 'imagem': //imagem
enviarimg('./banco_de-dados/imgs/cat.jpg', '© 2021 Matheus')
break
case 'video': //video
enviarvid('./banco_de-dados/videos/video1.mp4', '© 2021 Matheus')
break
case 'audio': //audio
...
break
case 'gif': //gif
enviargif('./banco_de-dados/gif/morte.mp4', '© 2021 Matheus')
break
// by dark. //
...
case 'rua':	
if(!q) return enviar('Digite o texto que vai aparecer na imagem | Exemplo: .rua Matheus')
...
`${q}`
 ...
 console.log(data)
  ...
  break
	case 'thunder':	
	if(!q) return enviar('Digite o texto que vai aparecer na imagem | Exemplo: .thunder Matheus')
	enviar('Aguarde, estou renderizando a imagem.')
    ...
    caption: '© 2021 Matheus'
	 ...
	 console.log(data)
	  ...
	  break
	  case 'glitch':	
	  if(!q) return enviar('Digite o texto que vai aparecer na imagem | Exemplo: .glitch Matheus')
	  enviar('Aguarde, estou renderizando a imagem.')
    ...
    caption: '© 2021 Matheus'
	   ...
	   console.log(data)
		...
		break
		case 'neon3d':	
		if(!q) return enviar('Digite o texto que vai aparecer na imagem | Exemplo: .neon3d Matheus')
		enviar('Aguarde, estou renderizando a imagem.')
    ...
    caption: '© 2021 Matheus'
		 ...
		 console.log(data)
		  ...
		  break
		  case 'blood':	
		  if(!q) return enviar('Digite o texto que vai aparecer na imagem | Exemplo: .blood Matheus')
		  enviar('Aguarde, estou renderizando a imagem.')
    ...
    caption: '© 2021 Matheus'
		   ...
		   console.log(data)
			...
			break
			case 'wall':	
			if(!q) return enviar('Digite o texto que vai aparecer na imagem | Exemplo: .wall Matheus')
			enviar('Aguarde, estou renderizando a imagem.')
    ...
    caption: '© 2021 Matheus'
			 ...
			 console.log(data)
			  ...
			  break
			  case 'joker':	
			  if(!q) return enviar('Digite o texto que vai aparecer na imagem | Exemplo: .joker Matheus')
			  enviar('Aguarde, estou renderizando a imagem.')
    ...
    caption: '© 2021 Matheus'
			   ...
			   console.log(data)
				...
				break
                case 'praia':	
				  if(!q) return enviar('Digite o texto que vai aparecer na imagem | Exemplo: .praia Matheus')
				  enviar('Aguarde, estou renderizando a imagem.')
    ...
    caption: '© 2021 Matheus'
				   ...
				   console.log(data)
					...
					break
					case 'fiction':	
					if(!q) return enviar('Digite o texto que vai aparecer na imagem | Exemplo: .fiction Matheus')
					enviar('Aguarde, estou renderizando a imagem.')
    ...
    caption: '© 2021 Matheus'
					 ...
					 console.log(data)
					  ...
					  break
					  case 'potter':	
					  if(!q) return enviar('Digite o texto que vai aparecer na imagem | Exemplo: .potter Matheus')
					  enviar('Aguarde, estou renderizando a imagem.')
    ...
    caption: '© 2021 Matheus'
					   ...
					   console.log(data)
						...
						break
						case 'neongreen':	
						if(!q) return enviar('Digite o texto que vai aparecer na imagem | Exemplo: .neongreen Matheus')
						enviar('Aguarde, estou renderizando a imagem.')
    ...
    caption: '© 2021 Matheus'
						 ...
						 console.log(data)
						  ...
						  break
						  case 'blood2':	
						  if(!q) return enviar('Digite o texto que vai aparecer na imagem | Exemplo: .blood2 Matheus')
						  enviar('Aguarde, estou renderizando a imagem.')
    ...
    caption: '© 2021 Matheus'
						   ...
						   console.log(data)
							...
							break
							case 'toxic':	
							if(!q) return enviar('Digite o texto que vai aparecer na imagem | Exemplo: .toxic Matheus')
							enviar('Aguarde, estou renderizando a imagem.')
    ...
    caption: '© 2021 Matheus'
							 ...
							 console.log(data)
							  ...
							  break
							  case 'metal':	
							  if(!q) return enviar('Digite o texto que vai aparecer na imagem | Exemplo: .metal Matheus')
							  enviar('Aguarde, estou renderizando a imagem.')
    ...
    caption: '© 2021 Matheus'
							   ...
							   console.log(data)
								...
								break
								case 'urso':	
								if(!q) return enviar('Digite o texto que vai aparecer na imagem | Exemplo: .urso Matheus')
								enviar('Aguarde, estou renderizando a imagem.')
...
case 'dono':
    txtdono = `
Dono da Base: Matheus

WhatsApp: +5592994604627
